...
namespace Game2048
{
    public partial class MainForm : Form
    {
        ...
        private void SetupMenu()
        {
            ...
            undoMenuItem = new ToolStripMenuItem("Назад", null, (s, e) => UndoMove())
            {
                Enabled = false
            };
            ToolStripMenuItem exitItem = new ToolStripMenuItem("Выход", null, (s, e) => this.Close());

            gameMenu.DropDownItems.AddRange(new ToolStripItem[] { newGameItem, undoMenuItem, exitItem });
        ...
        private void UpdateView()
        {
            ...
            undoMenuItem.Enabled = game.CanСancel;
        }
